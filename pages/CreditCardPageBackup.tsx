...
const CREDIT_CARDS: CreditCardType[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?w=400&h=250'
  },
  {
    id: 'nova-premium',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1559526324-593bc073d938?w=400&h=250'
  }
];
...
const CreditCardPage: React.FC = () => {
  ...
  const CreditCardDisplay: React.FC<{ card: CreditCardType, onSelect: () => void }> = ({ card, onSelect }) => (
    <AnimatedSection>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <p className="font-bold text-lg text-[#A41E22]">{card.cashbackRate}</p>
            </div>
            <div>
  ...
  const ApplicationForm: React.FC = () => (
    <AnimatedSection>
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Credit Card Application</h2>
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <p><span className="font-medium">Income:</span> ${parseInt(applicationData.annualIncome).toLocaleString()}</p>
                  <p><span className="font-medium">Employment:</span> {applicationData.employment}</p>
                  <p><span className="font-medium">Selected Card:</span> {selectedCard?.name}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 p-6 rounded-lg">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-green-800">Pre-Approval Check</h3>
              </div>
              <p className="text-green-700 text-sm mb-4">Based on your information, you're likely to be approved for this card with these estimated terms:</p>
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <p><span className="font-medium">Estimated Credit Limit:</span> $8,000 - $15,000</p>
                  <p><span className="font-medium">APR:</span> {selectedCard?.apr}</p>
                </div>
                <div>
                  <p><span className="font-medium">Approval Probability:</span> Excellent (90%+)</p>
                  <p><span className="font-medium">Processing Time:</span> Instant Decision</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between pt-6">
              ...
              <button 
                ...
                onClick={() => {
                  ...
                  alert('Application submitted successfully! You will receive a decision within 60 seconds.');
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Choose Your Perfect <span className="text-[#A41E22]">Credit Card</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover credit cards designed for your lifestyle. From cashback rewards to premium travel benefits, 
              find the card that matches your spending habits and financial goals.
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Why Choose NovaBank Credit Cards?</h2>
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Get approved in 60 seconds with our AI-powered decision engine</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <BanknotesIcon className="h-8 w-8 text-green-600" />
                </div>
                <h3 className="font-semibold text-gray-900 mb-2">Competitive Rewards</h3>
                <p className="text-gray-600 text-sm">Earn up to 3% cashback on every purchase with no caps or limits</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Bank-grade security with real-time fraud monitoring and alerts</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">AI-powered spending analysis and personalized financial tips</p>
              </div>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-gradient-to-br from-[#A41E22] to-[#8C1A1F] rounded-2xl shadow-2xl p-8 text-white text-center">
            ...
            <p className="text-xl text-white/90 mb-6">
              Join over 2.5 million satisfied customers who trust NovaBank for their credit needs.
            </p>
