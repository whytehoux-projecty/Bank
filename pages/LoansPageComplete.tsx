            ...
            <div className="relative p-6 text-white">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-sm text-white/80">{loan.type.replace('-', ' ').toUpperCase()}</p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCalculatorValues(prev => ({ ...prev, amount: parseInt(e.target.value) }))}
                  className="w-full"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCalculatorValues(prev => ({ ...prev, term: parseInt(e.target.value) }))}
                  className="w-full"
                />
                <div className="flex justify-between text-sm text-gray-500 mt-1">
                  <span>1 year</span>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCalculatorValues(prev => ({ ...prev, rate: parseFloat(e.target.value) }))}
                  className="w-full"
                />
                <div className="flex justify-between text-sm text-gray-500 mt-1">
                  <span>3.0%</span>
          ...
          <AnimatedSection>
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              <div className="mb-8">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Apply for {selectedLoan.name}</h2>
                <p className="text-gray-600">Complete your loan application in just a few minutes</p>
              </div>
              ...
              <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        ${applicationData.loanAmount ? 
                          ((parseInt(applicationData.loanAmount) * 0.08) / 12).toFixed(2) : 
                          '---'}
                      </p>
                    </div>
                  </div>
                ...
                <button 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert('Loan application submitted successfully! You will receive a decision within 24 hours.');
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              <span className="text-[#A41E22]">Loan Solutions</span> for Every Need
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're buying a home, starting a business, or consolidating debt, 
              our competitive rates and flexible terms help you achieve your financial goals.
            </p>
          </div>
        </AnimatedSection>
        ...
        <div className="mt-16">
          <AnimatedSection>
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Find the perfect loan for your financial situation</p>
            </div>
          </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Why Choose NovaBank for Your Loan?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Get approved in as little as 24 hours with our streamlined application process</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Enjoy some of the lowest interest rates in the market with flexible terms</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Your personal information is protected with bank-grade security</p>
              </div>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-gradient-to-br from-[#A41E22] to-[#8C1A1F] rounded-2xl shadow-2xl p-8 text-white text-center">
            ...
            <p className="text-xl text-white/90 mb-6">
              Take the first step towards your financial goals with NovaBank's competitive loan solutions.
            </p>
