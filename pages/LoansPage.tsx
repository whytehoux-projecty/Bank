        ...
        <AnimatedSection>
          <div className="relative overflow-hidden rounded-2xl shadow-2xl mb-16">
            <div
              ...
              style={{ backgroundImage: "url('/images/loans-feature.jpg')" }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent"></div>
              <div className="relative z-10 h-full flex items-center p-12">
                <div className="max-w-3xl">
                  <h1 className="text-5xl font-bold text-white mb-6">
                    <span className="text-red-300">Loan Solutions</span> for
                    Every Need
                  </h1>
                  <p className="text-xl text-white/90 mb-8">
                    Whether you're buying a home, starting a business, or
                    consolidating debt, our competitive rates and flexible terms
