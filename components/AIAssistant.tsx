...
const AIAssistant: React.FC = () => {
    ...
    if (isOpen && messages.length === 0) {
      setTimeout(() => {
        setMessages([
          {
            id: "ai-intro",
            text: "👋 Hello! I'm Nova, your personal AI banking assistant powered by advanced AI technology.\n\n🏦 I can help you with:\n• Account information & balances\n• Fund transfers & payments\n• Credit card applications & management\n• Banking services & products\n• Financial advice & planning\n• Security & fraud protection\n• General banking questions\n\nHow can I assist you today? Feel free to click on the quick actions below or just type your question!",
            sender: "ai",
            timestamp: Date.now(),
          },
        ]);
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    try {
      ...
      const aiResponseText = await callGeminiApi(currentInput, chatHistory);
