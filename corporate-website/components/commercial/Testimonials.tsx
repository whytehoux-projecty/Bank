                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-none shadow-vintage-xl p-8 md:p-12">
                        <div className="flex flex-col items-center text-center">
                            {/* Avatar */}
                            <div className="w-24 h-24 rounded-none border-4 border-vintage-green/10 mb-6 relative overflow-hidden">
                                <Image
                    ...
                    <button
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 w-12 h-12 rounded-none bg-white shadow-vintage-lg flex items-center justify-center text-vintage-green hover:bg-vintage-green hover:text-white transition-all"
                    ...
                    <button
                        onClick={goToNext}
                        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 w-12 h-12 rounded-none bg-white shadow-vintage-lg flex items-center justify-center text-vintage-green hover:bg-vintage-green hover:text-white transition-all"
