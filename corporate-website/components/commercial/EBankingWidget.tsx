        ...
        <div className={`bg-white/70 backdrop-blur-xl rounded-xl shadow-2xl border border-white/30 p-6 ${className}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            maxLength={12}
                            disabled={isChecking}
                            className="w-full h-12 pl-11 pr-4 rounded-none border border-faded-gray bg-white text-charcoal placeholder:text-charcoal-lighter focus:outline-none focus:ring-2 focus:ring-vintage-green focus:border-transparent transition-all disabled:opacity-50"
                        />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            disabled={isChecking}
                            className="w-full h-12 pl-11 pr-12 rounded-none border border-faded-gray bg-white text-charcoal placeholder:text-charcoal-lighter focus:outline-none focus:ring-2 focus:ring-vintage-green focus:border-transparent transition-all disabled:opacity-50"
                        />
                        <button
                            type="button"
                ...
                <button
                    type="submit"
                    disabled={isChecking}
                    className="w-full h-12 bg-vintage-green text-white font-semibold rounded-none hover:bg-vintage-green-dark transition-all shadow-vintage hover:shadow-vintage-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="text-center pt-4 border-t border-faded-gray-light">
                    <p className="text-sm text-charcoal-light">
                        Not registered?{' '}
                        <a href="/apply" className="text-vintage-green hover:text-vintage-green-dark font-semibold transition-colors">
                            Open an account →
                        </a>
                    </p>
                </div>
