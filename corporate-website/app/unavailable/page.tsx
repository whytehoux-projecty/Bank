                ...
                <div className="container mx-auto max-w-2xl">
                    ...
                    <div className="bg-white rounded-xl shadow-2xl border border-faded-gray-light p-8 md:p-12 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                            <button
                                ...
                                disabled={isChecking}
                                className="inline-flex items-center justify-center h-12 px-6 text-base font-semibold rounded-lg bg-heritage-navy text-white hover:bg-heritage-navy-dark transition-all shadow-vintage hover:shadow-vintage-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            >
                            ...
                            <Link
                                href="/"
                                className="inline-flex items-center justify-center h-12 px-6 text-base font-semibold rounded-lg bg-transparent text-heritage-navy border-2 border-heritage-navy hover:bg-heritage-navy hover:text-white transition-all"
                            >
                        ...
                        <div className="border-t border-faded-gray-light pt-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 text-left">
                                <div className="flex items-start gap-3 p-4 bg-off-white rounded-lg">
                                    <Phone className="w-5 h-5 text-heritage-navy mt-0.5 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-semibold text-charcoal mb-1">Call Us</h4>
                                        <a href="tel:1-800-574-3748" className="text-sm text-charcoal-light hover:text-heritage-navy transition-colors">
                                            1-800-574-3748
                                        </a>
                                ...
                                <div className="flex items-start gap-3 p-4 bg-off-white rounded-lg">
                                    <Mail className="w-5 h-5 text-heritage-navy mt-0.5 flex-shrink-0" />
                                    <div>
                                        <h4 className="font-semibold text-charcoal mb-1">Email Support</h4>
                                        <a href="mailto:support@jpheritage.com" className="text-sm text-charcoal-light hover:text-heritage-navy transition-colors">
                    ...
                    <div className="mt-6 text-center bg-white/60 backdrop-blur-lg rounded-xl p-6 border border-faded-gray-light">
                        <p className="text-sm text-charcoal-light">
                            ...
                            please visit our{' '}
                            <Link href="/about" className="text-heritage-navy hover:text-heritage-navy-dark font-semibold transition-colors">
                                about page
                            </Link>
