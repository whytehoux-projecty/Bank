...
export default function ServiceUnavailablePage() {
    ...
    const checkServiceStatus = async () => {
        setIsChecking(true);
        try {
            const response = await fetch(process.env.NEXT_PUBLIC_API_URL ? `${process.env.NEXT_PUBLIC_API_URL}/health` : 'http://localhost:3001/health');
            if (response.ok) {
            ...
            <header className="bg-white border-b border-faded-gray-light sticky top-0 z-50 backdrop-blur-sm bg-white/95">
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <Link href={process.env.NEXT_PUBLIC_CORPORATE_URL || 'http://localhost:3000'} className="-m-1.5 p-1.5 flex items-center gap-3">
                            <Image
                    ...
                    <div className="flex gap-4">
                        <Link
                            href={process.env.NEXT_PUBLIC_CORPORATE_URL || 'http://localhost:3000'}
                    ...
                    <div className="bg-white rounded-xl shadow-2xl border border-faded-gray-light p-8 md:p-12 text-center">
                        ...
                        {retryCount > 0 && (
                            <p className="text-xs text-gray-500 mb-6">
                                Status checked {retryCount} {retryCount === 1 ? 'time' : 'times'}
                            </p>
                        )}
                            ...
                            <div className="grid md:grid-cols-2 gap-4 text-left">
                                <div className="flex items-start gap-3 p-4 bg-off-white rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-charcoal-light">1-800-AURUM-88</p>
                                ...
                                <div className="flex items-start gap-3 p-4 bg-off-white rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-charcoal-light">support@aurumvault.com</p>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>
                                    <a href={`${process.env.NEXT_PUBLIC_CORPORATE_URL || 'http://localhost:3000'}/about`} className="text-warm-cream/80 hover:text-soft-gold transition-colors">
                                        About Us
                                    </a>
                                </li>
                                <li>
                                    <a href={`${process.env.NEXT_PUBLIC_CORPORATE_URL || 'http://localhost:3000'}/contact`} className="text-warm-cream/80 hover:text-soft-gold transition-colors">
                                        Contact
                                    </a>
                                </li>
                            </ul>
