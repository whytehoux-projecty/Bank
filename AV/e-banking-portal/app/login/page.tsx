...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Store token in localStorage for portal access
            // Note: api.auth.login already sets the token via setAccessToken inside api-client, 
            // but we can ensure it's set or handle additional logic here if needed.
            // The api.auth.login return value in api-client.ts returns response.data
            // helper checking: api-client.ts line 195 returns response.data.
            // But api.auth.login implementation ALREADY calls setAccessToken(accessToken);
    ...
    return (
        <main className="min-h-screen relative flex items-center justify-center py-12 px-4">
            {/* Background Image */}
            <Image
                src="/images/new/banking-login-bg.jpg"
            ...
            <div className="container mx-auto max-w-md">
                ...
                <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-2xl border border-white/30 p-8">
                    ...
                    <PortalStatusIndicator
                        healthCheckUrl={process.env.NEXT_PUBLIC_API_URL ? `${process.env.NEXT_PUBLIC_API_URL}/health` : 'http://localhost:3001/health'}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="#" className="text-sm text-vintage-green hover:text-vintage-green-dark transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        <div className="text-center pt-4 border-t border-faded-gray-light">
                            <p className="text-sm text-charcoal-light">
                                ...
                                <a
                                    href={process.env.NEXT_PUBLIC_CORPORATE_URL ? `${process.env.NEXT_PUBLIC_CORPORATE_URL}/signup` : 'http://localhost:3000/signup'}
                ...
                <div className="mt-6 text-center bg-white/60 backdrop-blur-lg rounded-xl p-6 border border-white/30">
                    ...
                    <a
                        href={process.env.NEXT_PUBLIC_CORPORATE_URL ? `${process.env.NEXT_PUBLIC_CORPORATE_URL}/apply` : 'http://localhost:3000/apply'}
