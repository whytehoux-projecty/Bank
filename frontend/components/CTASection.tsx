...
const CTASection: React.FC = () => {
  return (
    <AnimatedSection className="py-20 bg-gradient-to-br from-[#A41E22] via-[#8C1A1F] to-[#751016] relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-white/10 backdrop-blur-lg border border-white/20">
        <div className="absolute top-10 left-10 w-20 h-20 bg-white/20 rounded-full blur-xl"></div>
        <div className="absolute top-32 right-20 w-16 h-16 bg-white/20 rounded-full blur-lg"></div>
        <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-white/20 rounded-full blur-2xl"></div>
        <div className="absolute bottom-32 right-10 w-12 h-12 bg-white/20 rounded-full blur-md"></div>
      </div>
