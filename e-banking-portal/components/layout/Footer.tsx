...
export function Footer({ className, isAbsolute = false }: FooterProps) {
  return (
    <footer
      className={cn(
        "w-full bg-[color:var(--heritage-surface)]/95 backdrop-blur-md border-t border-[color:var(--heritage-navy)]/15 flex flex-col items-center justify-center py-6 z-40",
      ...
      <div className="flex flex-col items-center justify-center space-y-4 text-gray-500 text-xs font-light w-full">
        <div className="flex items-center flex-wrap justify-center gap-x-6 gap-y-2">
          <Link
            href="#"
            className="hover:text-[color:var(--heritage-navy)] hover:underline transition-colors">
            Contact us
          </Link>
          <Link
            href="#"
        ...
        <div className="flex flex-col items-center gap-1 opacity-80">
          ...
          <p>&copy; 2026 JP Heritage N.A. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
