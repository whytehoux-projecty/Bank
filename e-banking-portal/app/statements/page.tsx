...
export default function StatementsPage() {
    ...
    const fetchStatements = async () => {
        try {
            ...
            setStatements([]);
            toast.error({ title: 'Could not load statements', description: 'Please try again.' });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            toast.success({ title: 'Statement generated', description: 'Your new statement is ready to download.' });
        } catch (error) {
            console.error(error);
            toast.error({ title: 'Failed to generate statement', description: 'Please try again.' });
        } finally {
            setGenerating(false);
        }
    };
