...
A secure, feature-rich administrative interface for managing the JP Heritage Bank platform. Built with Fastify, TypeScript, and Prisma.
...
3. **Configure environment variables**:
   ...
   ```env
   # Database
   DATABASE_URL="postgresql://username:password@localhost:5432/jpheritage"
