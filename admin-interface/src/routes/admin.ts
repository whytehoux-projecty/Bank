...
export default async function adminRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/transactions', AdminController.createTransaction);
  ...
  // Account management
  fastify.get('/accounts', AdminController.getAccounts);
  fastify.post('/accounts', AdminController.createAccount);
  fastify.put('/accounts/:accountId', AdminController.updateAccount);
}