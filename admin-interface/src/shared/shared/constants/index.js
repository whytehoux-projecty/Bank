...
exports.API_CONFIG = {
    ...
    CORS_ORIGINS: ['http://localhost:3000', 'http://localhost:3002', 'https://jpheritage.com', 'https://admin.jpheritage.com'],
};
...
exports.EXTERNAL_SERVICES = {
    ...
    SENDGRID: {
        FROM_EMAIL: 'noreply@jpheritage.com',
        FROM_NAME: 'JP Heritage Bank',
    },
};
