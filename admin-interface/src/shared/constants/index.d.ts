export declare const API_CONFIG: {
    ...
    readonly CORS_ORIGINS: readonly ["http://localhost:3000", "http://localhost:3002", "https://jpheritage.com", "https://admin.jpheritage.com"];
};
...
export declare const EXTERNAL_SERVICES: {
    ...
    readonly SENDGRID: {
        readonly FROM_EMAIL: "noreply@jpheritage.com";
        readonly FROM_NAME: "JP Heritage Bank";
    };
};
