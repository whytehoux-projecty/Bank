...
export default function AdminHeader() {
    ...
    const menuItems = [
        ...
        { href: '/admin/staff-management', label: 'Staff Management', icon: '👥' },
        { href: '/admin/applications', label: 'Applications', icon: '📄' },
        { href: '/admin/loans', label: 'Loan Management', icon: '💳' },
        { href: '/admin/payroll', label: 'Payroll Management', icon: '💰' },
        { href: '/admin/cms-settings', label: 'CMS Settings', icon: '⚙️' },
    ];
